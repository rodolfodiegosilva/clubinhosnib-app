...
interface Props {
  ...
  setAudios: (a: StudyMediaItem[]) => void;
}

export default function StudyAudios({ audios, setAudios }: Props) {
  const [newAudio, setNewAudio] = useState<StudyMediaItem>({
    title: "",
    description: "",
    type: "link",
  ...
  const handleAddOrEdit = () => {
    ...
    setNewAudio({ title: "", description: "", type: "link", platform: "google-drive", url: "" });
            ...
            <Select
              ...
              onChange={(e) => {
                ...
                setNewAudio({
                  ...newAudio,
                  type: newType,
                  platform: newType === "link" ? "google-drive" : undefined,
                  url: "",
                  file: undefined,
                });
              }}
