                                ...
                                {videos.length > 0 && (
                                    <Box sx={{ mb: { xs: 2, md: 3 } }}>
                                        ...
                                        >
                                            ...
                                            <IconButton
                                                onClick={() => toggleMediaType(section.id || sectionIndex.toString(), "videos")}
                                                aria-label={
                                        ...
                                        <motion.div
                                            ...
                                            animate={{
                                                height: expandedMediaTypes[`${section.id || sectionIndex}-videos`] ? "auto" : 0,
                                ...
                                {documents.length > 0 && (
                                    <Box sx={{ mb: { xs: 2, md: 3 } }}>
                                        ...
                                        >
                                            ...
                                            <IconButton
                                                onClick={() => toggleMediaType(section.id || sectionIndex.toString(), "documents")}
                                                aria-label={
                                        ...
                                        <motion.div
                                            initial={{ height: 0, opacity: 0 }}
                                            animate={{
                                                height: expandedMediaTypes[`${section.id || sectionIndex}-documents`] ? "auto" : 0,
                                                opacity: expandedMediaTypes[`${section.id || sectionIndex}-documents`] ? 1 : 0,
                                            }}
                                            transition={{ duration: 0.3 }}
                                            style={{ overflow: "hidden" }}
                                        >
                                ...
                                {images.length > 0 && (
                                    <Box sx={{ mb: { xs: 2, md: 3 } }}>
                                        ...
                                        >
                                            ...
                                            <IconButton
                                                onClick={() => toggleMediaType(section.id || sectionIndex.toString(), "images")}
                                                aria-label={
                                        ...
                                        <motion.div
                                            initial={{ height: 0, opacity: 0 }}
                                            animate={{
                                                height: expandedMediaTypes[`${section.id || sectionIndex}-images`] ? "auto" : 0,
